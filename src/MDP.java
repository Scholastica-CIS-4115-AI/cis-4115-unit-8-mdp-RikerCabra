...
//			 {0, -999, 0, -999, 0, -999, 0, -999}};
	...
	char delta_name[] = { '^', '<', 'v', '>' }; // Use these when creating your
												// policy grid.
	...
	// check all possible moves at this location
	// return smallest value of the possible moves
			...
			for (int x = 0; x < grid.length; x++) {
				for (int y = 0; y < grid[0].length; y++) {
					...
					if (grid[x][y] == -999) {
						...
						// this is a goal, check to see if the value has been set
